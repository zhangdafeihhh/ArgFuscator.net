document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
        fetch('https://lolbas-project.github.io/api/lolbas.json')
            ...
            .then(x => { if (x.length > 0) { let command_count = x[0].Commands.length; a = document.createElement("a"); a.classList.add("button"); a.href = x[0].url; a.innerText = `LOLBAS Project (${command_count})`; document.getElementById("related-links").appendChild(a); } })
